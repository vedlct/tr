...
<div class="container-fluid" >
    <div class="row">
        ...
        <div class="col-lg-7">
            <form class="form-horizontal well" action="insertclient" method="post">
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="text" class="form-control" id="inputEmail" placeholder="Company Name" name="clientname">
                        </div>
                    </div>
                    <br>
